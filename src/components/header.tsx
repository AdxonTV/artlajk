...
const Header = () => {
  ...
  return (
    <div className="h-[100dvh] z-10 relative flex justify-center overflow-hidden text-white">
      <Cursor />
      <div className="w-[96vw] relative">
        <div className="w-full bottom-0 absolute  md:text-left">
     
          <div className="text-[4vh] mb-[5vh] md:w-[40vw] leading-[110%] md:text-[7vh]"> <div><div>Rozwiń się na Zajęciach </div> <div className="md:text-left text-right">z Malartwa i Rysunku</div> </div></div>
